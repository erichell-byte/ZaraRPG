...
{
    public class Agent_Entity_FollowEntityByNavMesh : Agent_FollowTargetByNavMesh
    {
        ...
        public Agent_Entity_FollowEntityByNavMesh(MonoBehaviour coroutineDispatcher) 
