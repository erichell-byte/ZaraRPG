...
{
    [AddComponentMenu("GameEngine/Mechanics/Melee Damage/Melee Damage Connector")]
    public sealed class UMeleeDamageConnector : MonoBehaviour
    {
        ...
        {
            var damage = this.baseValue.Value * this.multiplier.Value;
