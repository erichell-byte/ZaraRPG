...
namespace Game.Gameplay.Hero
{
    ...
    public abstract class AbstractTriggerObserver<T> : TriggerObserver where T : class
    {
        ...
        protected virtual void OnHeroEntered(T target)
        {
        }

        protected virtual void OnHeroExited(T target)
        {
        }
    }
}